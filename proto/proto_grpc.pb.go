...
type BankingServiceClient interface {
	...
	PCCommit(ctx context.Context, in *PCCommitMessage, opts ...grpc.CallOption) (*PCResponse, error)
	PCAbort(ctx context.Context, in *PCAbortMessage, opts ...grpc.CallOption) (*PCResponse, error)
...
func (c *bankingServiceClient) PCCommit(ctx context.Context, in *PCCommitMessage, opts ...grpc.CallOption) (*PCResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PCResponse)
...
func (c *bankingServiceClient) PCAbort(ctx context.Context, in *PCAbortMessage, opts ...grpc.CallOption) (*PCResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PCResponse)
...
type BankingServiceServer interface {
	...
	PCCommit(context.Context, *PCCommitMessage) (*PCResponse, error)
	PCAbort(context.Context, *PCAbortMessage) (*PCResponse, error)
...
func (UnimplementedBankingServiceServer) PCCommit(context.Context, *PCCommitMessage) (*PCResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PCCommit not implemented")
}
func (UnimplementedBankingServiceServer) PCAbort(context.Context, *PCAbortMessage) (*PCResponse, error) {
...
func _BankingService_PCCommit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BankingServiceServer).PCCommit(ctx, req.(*PCCommitMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BankingService_PCAbort_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BankingServiceServer).PCAbort(ctx, req.(*PCAbortMessage))
	}
	return interceptor(ctx, in, info, handler)
}
